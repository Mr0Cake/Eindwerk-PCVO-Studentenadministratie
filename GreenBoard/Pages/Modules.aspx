<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPageLoggedOff.master" AutoEventWireup="true" CodeFile="Modules.aspx.cs" Inherits="Pages_Modules" %>
    ...
    <div class="border">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12 margin-bottom">
                        ...
                        <h1>Modules</h1>
                        <asp:DropDownList ID="ddlModules" AutoPostBack="True" runat="server" DataSourceID="objOpleiding"
                            DataTextField="Naam" DataValueField="IDOpleiding">
                        </asp:DropDownList>
