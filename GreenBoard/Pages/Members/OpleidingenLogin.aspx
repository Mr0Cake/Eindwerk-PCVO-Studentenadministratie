<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MasterPage.master" AutoEventWireup="true" CodeFile="OpleidingenLogin.aspx.cs" Inherits="Pages_Members_Opleidingen" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12">
                    ...
                    <LayoutTemplate>
                        <dl>
                            <dt runat="server" id="itemPlaceHolder">
