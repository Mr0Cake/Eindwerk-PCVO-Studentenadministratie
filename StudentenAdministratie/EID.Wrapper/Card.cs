...
namespace EID.Wrapper
{
    public class Card : ICard
    {
        ...
        {
            BirthDate = TryGetDateOfBirth(cardData, "date_of_birth", "BirthDate");
        ...
        private DateTime TryGetDateOfBirth(IDictionary<string, byte[]> data, string key, string field)
        {
            DateTime stringData = DateTime.MinValue;
            ...
            else
            {
                try
                {
                    stringData = DateTime.Parse(System.Text.Encoding.ASCII.GetString(data[key]));
